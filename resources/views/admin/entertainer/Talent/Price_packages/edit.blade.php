                                        ...
                                        <div class="col-sm-6 pl-sm-0 pr-sm-3">
                                            <div class="form-group mb-2">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Price" aria-label="Price" name="price_package" Value="{{ $data['price_package']['price_package'] }}" aria-describedby="basic-addon2">
                                                </div>
                                                @error('price_package')
