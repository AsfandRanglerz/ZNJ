...
class UserController extends Controller
{
    public function index(){
        ...
        $data['entertainer']=User::select('id','name','email','role','phone','dob','country','city','gender','nationality','created_at')->where('role','entertainer')->with(['entertainerDetail' => function ($query) {$query->with('talentCategory'); }])->latest()->get();
